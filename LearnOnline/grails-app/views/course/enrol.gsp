	...
	<body>
		<g:if test="${session.user}"> <!-- Only print content if the user is logged in! -->
			...
			<g:else>
				...
				<div class="row">
			  		<div class="col-md-5">
						<g:form class="form-horizontal" role="form" controller="Course" action="putCourseOnUser">
							<legend><h2>Enrol in a Course</h2></legend>
							...
							<div class="form-group">
								<div class="col-sm-offset-3 col-sm-9">
									<g:submitButton class="btn btn-primary" name="submit" value="Enrol"/>
								</div>
							</div>
						</g:form>
